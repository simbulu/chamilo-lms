            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-6 col-lg-6">
                        <p class="date-time">{{ _s.date }}</p>
                    </div>
                    <div class="col-xs-12 col-md-6 col-lg-6">
                        <div class="pull-right">
                            <a class="btn btn-return" href="http://ucg3.beeznest.com">Regresar a portal web</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <header>
            <section id="main" class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                        <div id="items-left" class="col-xs-12 col-md-4  col-lg-4">
                            &nbsp;
                        ...
                        <div id="items-center" class="col-xs-12 col-md-4 col-lg-4">
                            &nbsp;
                        ...
                        <div id="items-right" class="col-xs-12 col-md-4 col-lg-4">
                            <img src="{{ _p.web_css}}/themes/{{ css_styles }}/images/logo_plataforma.png"/>
